...
1. Desplázate hacia abajo hasta que veas el **Método de escalabilidad horizontal**. Haz clic en la opción **Basado en reglas** y selecciona **Administrar el escalado basado en reglas**.
...
1. En la ventana de **Visual Studio Code**, en el panel del **Explorador**, vaya al directorio **bin\Debug\net8.0**.
    ...
    > **Nota**: para verificar que está en el directorio **bin\Debug\net8.0**, en Visual Studio Code, en el menú Archivo, seleccione Abrir carpeta, vaya a **Allfiles (F):\\Allfiles\\Labs\\11\\Starter\\Api\\bin\\Release\\net8.0\win-x86\publish** y, después, elija **Seleccionar carpeta**.

1. En la ventana **Visual Studio Code**, en la barra de menús, seleccione **Terminal** y, a continuación, **Nuevo terminal**.

1. En el símbolo del sistema del terminal, ejecute el comando siguiente para asegurarse de que el directorio actual está establecido en **Allfiles (F):\\Allfiles\\Labs\\11\\Starter\\Api\\bin\\Release\\net8.0\\net8.0\\win-x86\\publish**, donde residen los archivos de implementación:
