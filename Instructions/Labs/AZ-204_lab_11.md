...
1. Desplázate hacia abajo hasta que veas el **método de escalabilidad horizontal**. Haga clic en la opción **Basado en reglas** y luego seleccione **Administrar el escalado basado en reglas**.
...
1. En la ventana **Visual Studio Code**, en la barra de menús, seleccione **Terminal** y después **Nuevo terminal**.
