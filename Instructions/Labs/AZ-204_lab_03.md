...
1. En la pestaña **Opciones avanzadas**, asegúrate de que la opción **Permitir el acceso anónimo en contenedores individuales** esté activada. Activa esta opción si no lo está.
...
1. En el terminal, ejecuta el comando siguiente para importar la versión 12.12.0 de **Azure.Storage.Blobs** de NuGet:
