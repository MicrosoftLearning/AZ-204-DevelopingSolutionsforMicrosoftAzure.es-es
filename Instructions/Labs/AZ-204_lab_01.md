...
1. En la hoja  **Claves de acceso** , revisa cualquiera de las claves (usando el botón **Mostrar**) y luego copia en el portapapeles el valor de cualquiera de los cuadros  **Cadena de conexión** .
...
1. En la ventana **Nuevo contenedor**, lleve a cabo las acciones siguientes:
   ...
   | Lista **Nivel de acceso público** | Selecciona **Privado (sin acceso anónimo)** y luego selecciona **Crear** |
...
1. En la sección **Configuración**, realice las siguientes acciones, seleccione **Guardar** y, a continuación, seleccione **Continuar**.
   ...
   | Casilla **Configuración de la ranura de implementación**          | Conserve el valor predeterminado y, a continuación, seleccione **Aceptar** para cerrar el cuadro de diálogo emergente y volver a la sección **Configuración**. |
      | **Haga clic en **Guardar** en el menú superior           | Esto guardará el valor de configuración que acaba de escribir |

   Espere a que se guarde la configuración de la aplicación antes de continuar con el laboratorio.

1. En la hoja **App Service** de la sección Configuración, seleccione el vínculo **Propiedades** para ver más información sobre App Services.
...
1. Escriba el siguiente comando y, a continuación, seleccione ENTRAR para implementar el archivo **api.zip** en la aplicación web que creó anteriormente en este laboratorio:
   ...
   > **Nota**: Reemplace el marcador de posición _\<name-of-your-api-app\>_ por el nombre de la aplicación web que creó anteriormente en este laboratorio. Recientemente ha consultado el nombre de esta aplicación en los pasos anteriores.
...
1. Escriba el siguiente comando y, a continuación, seleccione ENTRAR para implementar el archivo **web.zip** en la aplicación web que creó anteriormente en este laboratorio:
   ...
   > **Nota**: Reemplace el marcador de posición _\<name-of-your-web-app\>_ por el nombre de la aplicación web que creó anteriormente en este laboratorio. Recientemente ha consultado el nombre de esta aplicación en los pasos anteriores.
...
1. En la página web **Galería de fotos de Contoso**, en la sección **Cargar una nueva imagen**, realice las siguientes acciones:
   ...
   b. En la ventana **Explorador de archivos**, vaya a **Allfiles (F):\\Allfiles\\Labs\\01\\Starter\\Images**, seleccione el archivo **bahnmi.jpg** y luego seleccione **Abrir**.
