...
1. Si tiene la pestaña **Configuración de la aplicación**en la sección **Configuración**, realice las siguientes acciones, seleccione **Guardar**, y a continuación, seleccione **Continuar**.
...
1. Si no tiene pestaña **Configuración de la aplicación** de la sección **Configuración**, compruebe si tiene el vínculo **Variables de entorno** en la sección **Configuración**, selecciónelo y realice las siguientes acciones:

   | Configuración                                        | Acción                                                                                                                  |
   | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
   | Pestaña **Configuración de la aplicación**                           |  Seleccionar                                                                                                                 |
   | Primer cuadro de texto disponible en la columna **Nombre** |  **StorageConnectionString**                                                                                            |   
   | Cuadro de texto de la columna **Valor**                | Pegue la cadena de conexión de almacenamiento que copió anteriormente en Bloc de notas.                                               |
   | Haga clic en **Aplicar** en la parte inferior                  | Se abrirá el elemento emergente de confirmación                                                                                  | 
   | Haga clic en **Confirmar** en la ventana emergente de confirmación | Esto guardará el valor de configuración que acabas de escribir. |
