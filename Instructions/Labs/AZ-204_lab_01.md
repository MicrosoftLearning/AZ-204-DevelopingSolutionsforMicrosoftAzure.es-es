...
1. En la ventana **Nuevo contenedor**, lleve a cabo las acciones siguientes:
   ...
   | Lista **Nivel de acceso público** | Selecciona **Privado (sin acceso anónimo)** y luego **Crear** |
...
1. En la hoja **Crear aplicación web**, en la pestaña **Aspectos básicos**, realice las acciones siguientes y, a continuación, seleccione la pestaña **Supervisión**:
   ...
   | Lista desplegable de la **pila en tiempo de ejecución**   | Seleccione **NET 8 (versión preliminar de LTS)**                                                                                 |
...
1. En la hoja **Crear aplicación web**, en la pestaña **Aspectos básicos**, realice las acciones siguientes y, a continuación, seleccione la pestaña **Supervisión**:
   ...
   | Sección **Publicar**                | Seleccione **Código**.               |
   | Lista desplegable de la **pila en tiempo de ejecución**   | Seleccione **NET 8 (LTS) (versión preliminar)**       |
   | Sección **Sistema operativo**       | Seleccione **Windows**            |
   | Lista desplegable de **Región**          | Seleccionar la región **Este de EE. UU.** |
