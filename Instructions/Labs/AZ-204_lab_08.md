...
1. En la hoja **Crear aplicación web**, en la pestaña **Aspectos básicos**, realice las siguientes acciones:
    ...
    | Sección **Plan de precios** | Seleccione **Explorar planes de precios**, en la página **Seleccionar plan de precios de App Service**, seleccione **S1** y, a continuación, elija **Seleccionar**. |
...
1. En la sección **Respuesta de HTTP**, realice los pasos siguientes:
    ...
    1. Si se abre el elemento emergente habilitar la confirmación de seguimiento, selecciona el botón **Habilitar seguimiento durante una hora**. 
