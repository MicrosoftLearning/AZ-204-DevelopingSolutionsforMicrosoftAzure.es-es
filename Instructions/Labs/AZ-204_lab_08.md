...
1.  En la aplicación web, realice las siguientes acciones:
    ...
    1.  Seleccione **Formatos de respuesta**.

    1.  Seleccione **GET /html**.

    1.  Haga clic en **Probar**.

    1.  Seleccione **Execute**(Ejecutar).

    1.  Revise el valor de los cuadros de texto **Cuerpo de la respuesta** y **Encabezados de respuesta**.

    1.  Revise el valor del cuadro de texto **Dirección URL de la solicitud**.

1.  En la aplicación web, realice las siguientes acciones:

    1.  Seleccione **Datos dinámicos**.

    1.  Seleccione **GET /bytes/{n}** .

    1.  Haga clic en **Probar**.

    1.  En el cuadro de texto **n**, escriba **25**.

    1.  Seleccione **Execute**(Ejecutar).

    1.  Revise el valor de los cuadros de texto **Cuerpo de la respuesta** y **Encabezados de respuesta**.

    1.  Seleccione **Descargar archivo** y, una vez descargado el archivo, ábralo en el Bloc de notas, revise su contenido y, a continuación, cierre el archivo.
...
1.  En la aplicación web, realice las siguientes acciones:
    ...
    1.  Seleccione **Códigos de estado**.

    1.  Seleccione **GET /status/{codes}** .

    1.  Haga clic en **Probar**.

    1.  En el cuadro de texto **Códigos**, escriba **404**.

    1.  Seleccione **Execute**(Ejecutar).

    1.  Revise la **respuesta del servidor** y observe que incluye la entrada **Error: NO ENCONTRADO**.
