...
ms.locfileid: "145995002"
---
# <a name="lab-04-develop-solutions-that-use-azure-cosmos-db"></a>Laboratorio 04: Desarrollo de soluciones que usan Azure Cosmos DB
...
1.  En el panel **Seleccionar opción de API**, seleccione **Crear** en el cuadro **Núcleo (SQL): opción recomendada**.
