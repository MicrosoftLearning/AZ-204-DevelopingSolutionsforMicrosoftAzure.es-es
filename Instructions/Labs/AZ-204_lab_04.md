...
1. En el panel  **Claves** , en la pestaña **Claves de lectura y escritura**, registre los valores de los cuadros de texto **URI**, **CLAVE PRINCIPAL** y **CADENA DE CONEXIÓN PRINCIPAL**. Los usará más adelante en el laboratorio.
...
1. Actualice la propiedad  **BlobContainerUrl** ; para ello, establezca su valor en la propiedad  **URL** del contenedor de blobs de Azure Storage denominado **images** que registró anteriormente en este laboratorio.
