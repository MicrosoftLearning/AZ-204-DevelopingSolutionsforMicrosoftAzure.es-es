...
1. En el símbolo del sistema de **Cloud Shell** del portal, realice las siguientes acciones:
    ...
    a.  Escriba el siguiente comando para comprobar si el Microsoft. Se ha registrado la red CDN. Siga con el Paso 2. si el Microsoft. La red CDN ya se ha registrado:

    ```bash
    az provider show --namespace Microsoft.CDN --query "registrationState"
    ```

    b.  Si el Microsoft. La red CDN no se ha registrado. Escriba el siguiente comando y, a continuación, seleccione ENTRAR para registrar el espacio de nombres de **Microsoft.CDN** con la suscripción actual:
...
1. En la hoja **Crear un recurso**, en el cuadro de texto **Servicios Search y Buscar Servicios y Marketplace**, escriba **CDN** y, a continuación, seleccione ENTRAR.

1. En la hoja de resultados de búsqueda de **Buscar Servicios y Marketplace**, seleccione el resultado **Perfiles de Front Door y CDN** y, luego, elija **Crear**.
...
### Ejercicio 5: Limpieza de la suscripción
...
#### Tarea 3: Cierre de la aplicación activa
