...
1. Cambie a la aplicación **Terminal Windows**.
...
1. Vuelva a la ventana **Visual Studio Code** y, desde el panel **Explorer**, abra el archivo **Dockerfile**.
...
1. En el panel de **Cloud Shell**, seleccione el botón cargar/descargar (representado por una página plegada con dos flechas que apuntan en las direcciones opuestas en la esquina inferior derecha) y, en el menú desplegable, seleccione **Cargar**.

1. En el cuadro de diálogo **Abrir** vaya al directorio vacío **Allfiles (F):\\Allfiles\\Labs\\05\\Starter\\func**, seleccione **lab05.zip** y, a continuación, seleccione **Abrir**.
...
1. En la hoja del repositorio, en la sección **Configuración**, seleccione **Claves de acceso**.

1. En la hoja **Clave de acceso**, active la casilla **Usuario administrador**.

1. En la hoja del repositorio, en la sección **Servicios**, seleccione **Repositorios**. 

1. En la lista de repositorios, seleccione **ipcheck**.
...
1. Seleccione el vínculo devuelto por el comando `az containerapp create` para comprobar que la aplicación de contenedor está en ejecución.
