...
1. En Azure Portal, seleccione el icono **Cloud Shell**, ![icono Cloud Shell](./media/az204_lab_CloudShell.png), para abrir una instancia de Cloud Shell. Si Cloud Shell tiene como valor predeterminado una sesión de PowerShell, seleccione **Cambiar a Bash** en el menú de **Cloud Shell** y, a continuación, seleccione **Confirmar**.
