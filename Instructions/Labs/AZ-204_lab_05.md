...
#### Tarea 3: Apertura de Cloud Shell y el editor
...
1. Cambia el modificador en la sección de usuario administrador para habilitar el usuario administrador para este registro de contenedor.
