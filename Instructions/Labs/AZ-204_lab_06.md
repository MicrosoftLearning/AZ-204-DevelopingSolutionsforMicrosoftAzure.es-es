...
## <a name="ensure-that-your-local-lab-environment-has-its-time-set-properly-no-delay-according-to-your-timezone"></a>Asegúrese de que el entorno de laboratorio local tenga su tiempo establecido correctamente (sin retraso, según la zona horaria).
