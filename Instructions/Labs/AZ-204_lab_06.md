...
1.  In the <bpt id="p1">**</bpt>Overview<ept id="p1">**</ept> section, find and record the value of the <bpt id="p2">**</bpt>Directory (tenant) ID<ept id="p2">**</ept> text box. You'll use this value later in the lab.
...
1.  Ejecute el siguiente comando para identificar el nombre principal de usuario (UPN) del usuario de Azure AD recién creado:
    ...
    > <bpt id="p1">**</bpt>Note<ept id="p1">**</ept>: Record the UPN. You'll use this value later in the lab.
...
1.  Ejecute los comandos siguientes para compilar la aplicación web de .NET:
    ...
    > <bpt id="p1">**</bpt>Note<ept id="p1">**</ept>: If there are any build errors, review the files in the <bpt id="p2">**</bpt>Allfiles (F):<ph id="ph1">\\</ph>Allfiles<ph id="ph2">\\</ph>Labs<ph id="ph3">\\</ph>06<ph id="ph4">\\</ph>Solution<ph id="ph5">\\</ph>OIDCClient<ept id="p2">**</ept> folder. Ignore any warning messages.
...
1.  When prompted to select the account to sign out, select the <bpt id="p1">**</bpt>aad_lab_user1<ept id="p1">**</ept> Azure AD account. You'll be automatically redirected to the <bpt id="p1">**</bpt>Signed out<ept id="p1">**</ept> page.
...
1.  En la sección **webappoidc**, realice las siguientes acciones:
    ...
    a.   Select <bpt id="p1">**</bpt>Delete<ept id="p1">**</ept>.

    b.   On the <bpt id="p1">**</bpt>Delete app registration<ept id="p1">**</ept> blade, select <bpt id="p2">**</bpt>I understand the implications of deleting this app registration<ept id="p2">**</ept>, and then select <bpt id="p3">**</bpt>Delete<ept id="p3">**</ept>.
