...
ms.openlocfilehash: 4252e1973caf5f15d5da41e0ec361fa970fa895c
ms.sourcegitcommit: d2d374fffa4fcbf92b9c4bdc9c9ecc470152e033
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 11/16/2021
ms.locfileid: "132626172"
---
...
1. En la hoja **Crear una cuenta de almacenamiento**, en la pestaña **Aspectos básicos**, realice las siguientes acciones y seleccione **Revisar y crear**:
   ...
   | Cuadro de texto **Nombre de la cuenta de almacenamiento** | Escriba **securestor** _[yourname]_ .                            |
...
1. En la hoja **Cuentas de almacenamiento**, seleccione la instancia de la cuenta de almacenamiento **securestor** _[yourname]_ .
...
1. En la hoja **Crear aplicación de funciones**, en la pestaña **Aspectos básicos**, realice las siguientes acciones y, a continuación, seleccione **Siguiente: Hosting**:
    ...
    | Cuadro de texto del **nombre de la aplicación de funciones**    | Escriba **securefunc** _[yourname]_ . |
...
1. En la pestaña **Hosting**, realice las siguientes acciones y, a continuación, seleccione **Revisar y crear**:
    ...
    | Configuración                            | Acción                                                 |
    | ---------------------------------- | ------------------------------------------------------ |
    | Lista desplegable de **cuenta de almacenamiento** | Seleccione la cuenta de almacenamiento **securestor** _[yourname]_ . |
...
1. En la hoja **Agregar directiva de acceso**, realice las siguientes acciones y, a continuación, seleccione **Agregar**:
    ...
    | Lista desplegable de **permisos de clave** | 0 seleccionado.      |
    | Lista desplegable de **permisos de secreto** | Seleccione el permiso **GET**. |
    | Lista desplegable de **permisos de certificado** | 0 seleccionado. |
