...
1. Ve a la pestaña **Configuración de acceso** y cambia el modelo de permisos a la **Directiva de acceso del almacén**.
...
1. En la hoja **Crear una directiva de acceso**, selecciona la sección **Permisos** y haz lo siguiente:
...
1. Selecciona la sección **Principal** y haz las siguientes selecciones:
...
1. Selecciona **Revisar y crear** y después elige **Crear**.
...
1. En la hoja **Function App**, selecciona la opción **Información general**.

1. En la pestaña **Funciones** de la parte inferior de la página Información general, selecciona la función **FileParser** existente.
...
1. Ahora debería mostrarse un mensaje de error que indica que no se encontró el recurso.
   ...
   > **Nota**: Esto es de esperar, ya que el contenedor es privado.
