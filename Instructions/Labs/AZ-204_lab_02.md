...
#### <a name="task-3-register-azure-storage-blob-extensions"></a>Tarea 3: Registro de extensiones de Azure Storage Blob
...
1. #### <a name="task-4-write-http-triggered-and-blob-inputted-function-code"></a>Tarea 4: Escritura de código de función desencadenado por HTTP e introducido por blob
